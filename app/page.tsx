      ...
      <section className="hero">
        <div className="container hero-grid">
          <div>
            ...
            <h1 className="h1">
              Reliable Supply of Building Materials for Construction and Project
              Requirements
            </h1>
          ...
          <div className="hero-card">
            <div className="hero-card-grid">
              ...
              <div className="hero-box">
                ...
                <strong>Practical material support for project requirements in the UAE</strong>
              </div>
            ...
            <div className="hero-panel">
              ...
              <p>
                ...
                serving site demand, trading supply, and project-based purchase
